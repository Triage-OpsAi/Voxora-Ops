...
import { Activity, BarChart3, Bot, ChevronDown, CircleDot, LayoutDashboard, Menu, MessageSquareText, PhoneCall, Search, Settings, Sparkles, Users, X } from "lucide-react";
...
const nav=[
  ["Overview","/",LayoutDashboard],["Leads","/leads",Users],["Conversations","/conversations",MessageSquareText],["Calls","/calls",PhoneCall],["Agents","/agents",Bot],["Analytics","/analytics",BarChart3],["Settings","/settings",Settings],
] as const;

export function AppShell({children}:{children:React.ReactNode}){
  const pathname=usePathname(); const {sidebarOpen,setSidebarOpen}=useUIStore(); useRealtime();
